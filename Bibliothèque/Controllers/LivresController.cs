...
namespace Bibliothèque.Controllers
{
    public class LivresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titre,TomeNum,TitreSerie")] Livre livre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titre,TomeNum,TitreSerie")] Livre livre)
        {
            if (id != livre.Id)
            {
                return NotFound();
